...
export const AboutPassion:React.FC = (): JSX.Element => {
    return(
        <div className={classes.passion__wrapper}>
            ...
            <CustomImage customClass={classes.passion__image__wrapper__one} src={'/../public/img/kamila2.jpg'} alt={"Zdjęcie przedstawiające Kamilę"}/>
            <CustomImage customClass={classes.passion__image__wrapper__two} src={'/../public/img/kamila3.jpg'} alt={"Zdjęcie przedstawiające pasję Kamili"}/>
