    ...
    return(
        <section className={classes.about__wrapper}>
            <div className={classes.about__margin}>
                ...
                <CustomImage customClass={classes.about__picture__wrapper} src={'/static/images/kamila2.jpg'} alt={"Zdjęcie pary"}/>
                <CustomImage customClass={classes.about__picture__wrapper__two} src={'/static/images//kamila3.jpg'} alt={"Zdjęcie pary"}/>
